...
def evaluate(rst,lbl):
    ...
    rstimg = cv2.resize(rstimg,(rstimg.shape[1]//4,rstimg.shape[0]//4))
...
if __name__ == '__main__':
    for method in ['deeptest_1','deeptest_2','deeptest_4','deeptest_3','deeptest_5']:
        filePath = 'data_deeptest_new/IBM_'+method+'_seg/'
        ...
        for file in filelist:
            ...
            labelfile = 'data_deeptest_new/IBM_'+method+'_label/' + filename
        ...
        f = codecs.open('log/0.7_ST3/log_IBM_'+method+'_eval_0.7.txt','a','utf-8')
        f.write(str(erroneouslist_seven))
        f.close()
        f = codecs.open('log/0.8_ST3/log_IBM_'+method+'_eval_0.8.txt','a','utf-8')
        f.write(str(erroneouslist_eight))
        f.close()
        f = codecs.open('log/0.85_ST3/log_IBM_'+method+'_eval_0.85.txt','a','utf-8')
