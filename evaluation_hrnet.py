...
if __name__ == '__main__':
    for method in ['guided_1']:
        filePath = 'data/hrnet_'+method+'_seg/'
        with open('log_hrnet_'+method+'.txt') as f:
        ...
        for file in filelist:
            ...
            labelfile = 'data/hrnet_'+method+'_label/' + filename
        ...
        f = codecs.open('log_hrnet_'+method+'_eval_0.1.txt','a','utf-8')
        f.write(str(erroneouslist_1))
        f.close()
        f = codecs.open('log_hrnet_'+method+'_eval_0.3.txt','a','utf-8')
        f.write(str(erroneouslist_3))
        f.close()
        f = codecs.open('log_hrnet_'+method+'_eval_0.5.txt','a','utf-8')
        f.write(str(erroneouslist_5))
        f.close()
        f = codecs.open('log_hrnet_'+method+'_eval_0.7.txt','a','utf-8')
        f.write(str(erroneouslist_7))
        f.close()
        f = codecs.open('log_hrnet_'+method+'_eval_0.9.txt','a','utf-8')
